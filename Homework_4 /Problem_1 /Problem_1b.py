...
lower_bound = i_eq + 1.96*np.sqrt(i_eq*(1-i_eq)/1000)
upper_bound = i_eq - 1.96*np.sqrt(i_eq*(1-i_eq)/1000)

R0_upper_bound = 1/(1-upper_bound*(gamma/mu+1))
R0_lower_bound = 1/(1-lower_bound*(gamma/mu+1))
