...
lower_bound = sero + 1.96*np.sqrt(sero*(1-sero)/1000)
upper_bound = sero - 1.96*np.sqrt(sero*(1-sero)/1000)

R0_upper_bound = 1/(1-upper_bound)
R0_lower_bound = 1/(1-lower_bound)
